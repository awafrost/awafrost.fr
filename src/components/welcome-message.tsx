...
export function WelcomeMessage() {
  ...
  return (
    <div className='fixed bottom-6 left-6 right-6 z-[60] mx-auto flex max-w-xl items-center justify-between gap-4 rounded-2xl border border-white/15 bg-[#111111]/95 p-5 shadow-2xl backdrop-blur-md'>
      <div>
        <p className='text-xs font-bold uppercase tracking-[0.25em] text-white'>Bienvenue chez Frost</p>
        <p className='mt-2 text-sm text-gray-400'>Retrouve ici mes actus, mes jeux favoris et les prochains giveaways.</p>
      </div>
