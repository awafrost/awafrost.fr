...
export function RobloxStatus({ userId }: RobloxStatusProps) {
    ...
    return (
      <div className="space-y-6 py-4 animate-pulse">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="h-20 bg-white/[0.015]" />
          <div className="h-20 bg-white/[0.015]" />
        </div>
      </div>
    );
  ...
  return (
    <motion.div
      className="space-y-8 py-4 relative overflow-hidden"
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 flex items-center gap-2 text-gray-400">
      ...
      <div className="relative group">
        <div className="space-y-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm md:text-base text-gray-400 hover:text-white transition-colors font-light italic break-all"
          >
      ...
      <div className="pt-4 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="px-2 py-1 text-[9px] font-bold uppercase tracking-widest text-gray-400">
